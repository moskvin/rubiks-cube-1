...
>>>>>>> 980d1ccc50b8abe07b1924a6e47165b6cbc33a50
									...
									if (e.getActionCommand().equals("  Помощь  ")){
										String s= "Пример рабочего кода:\n повернуть 5 поЧасовой - поворачивает 5-ую плоскость по часовой стрелке\n повернуть 5 прЧасовой - поворачивает 5-ую плоскость против часовой стрелки\n отменить 1 - отменяет 1 последнюю команду\n повторить 3 раз - повторяет 3 раза команды, находящиеся между 3 и раз\n заново - возвращает кубик в исходное состояние ";
